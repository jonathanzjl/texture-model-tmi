...
\title{Learning Parameters of a 3D Solid Breast Texture Model from
  clinical data} % from Clinical Breast Computerized Tomography Data
...
medium scale parameters for VOI \#1, \#2 and \#3. By applying learning
from reconstruction to all the 12 input bCT VOIs, 12 new sets of
medium scale parameters were finally obtained.
