...
\author{Zhijin~Li, Ann-Katherine~Carton, Serge~Muller,
  Thomas~Almecija, Pablo~Milioni~de~Carlvalo and
...
\begin{figure}[!htbp]
  \centering \includegraphics[width=0.4\textwidth]{model}
...
compartments, where the individual ellipsoids are not directly
\textit{observable}. This unobservability makes the inference problem
highly ill-posed.
